!function(e, t) {
    ...
    function d(e, t) {
        return e instanceof Date && (t = e.getMonth(),
        e = e.getFullYear()),
        [31, function(e) {
    ...
    function u(e, t, n) {
        for (var i = 0; i < t.length; i++) {
            var a = e
              , r = t[i];
            if ("year" == n ? (a = a.getFullYear(),
            r = r.getFullYear()) : "month" == n ? (a = a.getMonth(),
            r = r.getMonth()) : (a = a.getTime(),
            r = r.getTime()),
            a == r)
                return !0
        }
    ...
    function v(t) {
        for (var n = Array.prototype.slice.call(arguments, 1), i = 0; i < n.length; i++)
            for (var a in n[i])
                void 0 !== t[a] && "object" === e(n[i][a]) && null !== n[i][a] && void 0 === n[i][a].nodeName ? (n[i][a]instanceof Date && (t[a] = new Date(n[i][a].getTime())),
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                var n = function(e, t) {
                    ...
                    return this.node && (h(this.node, n, e),
                ...
                .bind(this)
                  , a = function(e, t) {
                    var n = t.deserialize;
                    return e.length && (e = f(_(e, n, this)),
                    e = [].concat(e).filter(p)),
                    !!e.length && e
                }
                .bind(this)
            ...
            value: function() {
                var e = this;
                this._isInitialized || (this._highlighted = [],
                this._onmousedown = this._onmousedown.bind(this),
                this._onmousemove = this._onmousemove.bind(this),
                this._onmouseup = this._onmouseup.bind(this),
                this._onclick = this._onclick.bind(this),
                "input" !== this._el.tagName.toLowerCase() ? this._el.addEventListener("click", function() {
                    return e.toggle()
            ...
            value: function(e) {
                ...
                this._highlighted = [f],
                this._dragStart = f,
                r || a("[data-day]." + u, this.wrapper).forEach(function(e) {
                    l(e, u)
                }),
            ...
            value: function(e) {
                ...
                n && !this._isDragging || (this._highlighted = [],
            ...
            value: function(e) {
                ...
                n.hasAttribute("data-prev") ? this.prev(n.dataset.prev) : n.hasAttribute("data-next") ? this.next(n.dataset.next) : n.hasAttribute("data-year") && !n.onchange ? n.onchange = function() {
                    ...
                    t._month.setFullYear(parseInt(n.value) - (e - i)),
                    t.render()
                }
            ...
            value: function(e, t) {
                if (e) {
                    if (m(e)) {
                        ...
                        e.serialize && (this.set("serialize", e.serialize),
                        delete e.serialize),
                        e.deserialize && (this.set("deserialize", e.deserialize),
                    ...
                    return this._isOpen && this.wrapper && this.render(),
                    t
                }
            }
        }, {
            ...
            key: "hide",
            value: function() {
                this._opts.inline || (this.wrapper.style.display = "none",
                this._isOpen = !1)
            }
        }, {
            key: "toggle",
            ...
            key: "hasDate",
            value: function(e) {
                return e = f(p(e) ? e : this._opts.deserialize(e)),
            ...
            value: function() {
                ...
                if (this._selected = (this._selected || []).sort(),
                n || t) {
                    var r = this._selected.map(function(e) {
                        return new Date(e)
                    });
                    if (i && r.length && (r[0].setHours(a[0], a[1]),
                    r.length > 1)) {
            ...
            value: function(e, t, n) {
                var i = this._opts
                  , a = i.time
                  , r = i.defaultTime;
                a && (!0 !== e && this._time || (this._time = v({}, r)),
            ...
            value: function(e) {
                ...
                i && o.length) {
                    var l = o.sort(c)[0];
                    if (this.setTime("start", l.getHours(), l.getMinutes()),
                    "ranged" === i || n) {
                        var h = o[o.length - 1];
            ...
            value: function(e, t) {
                var n = this._opts
                  ...
                  , l = void 0
                  , h = l = !0;
                return e = f(p(e) ? e : o(e)),
                "month" == t ? (h = !i || e.getMonth() >= i.getMonth(),
                l = !a || e.getMonth() <= a.getMonth()) : "year" == t ? (h = !i || e.getFullYear() >= i.getFullYear(),
                l = !a || e.getFullYear() <= a.getFullYear()) : (h = !i || e >= i,
                l = !a || e <= a),
                ...
                if (!this._noRender && this._renderers) {
                    ...
                    this.wrapper.innerHTML = this._renderers.container({
                        ...
                        renderTimepicker: function() {
                            var t = "";
                            return a && (t = e._renderTimepicker("start"),
            ...
            value: function() {
                ...
                y.setDate(d(y));
                for (var w = [], b = g.getDay() - i; b < 0; )
                    b += 7;
                for (var k = d(v, m) + b; k % 7; )
                    k += 1;
            ...
            value: function(e) {
                ...
                if (a) {
                    ...
                    var s = this._time[e]
                      , o = r.time[0];
                    return ("ranged" === a || i) && (o = r.time["start" === e ? 1 : 2]),
